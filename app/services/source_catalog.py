...
CS_RECOMMENDED_SOURCES: tuple[dict[str, str], ...] = (
    ...
    {"name": "Check Point Careers Israel", "kind": "smartrecruiters", "identifier": "CheckPointSoftwareTechnologies2", "company_name": "Check Point"},
    ...
    {"name": "AppsFlyer Careers Israel", "kind": "greenhouse", "identifier": "appsflyer", "company_name": "AppsFlyer"},
    ...
    {"name": "ServiceNow Careers Israel", "kind": "smartrecruiters", "identifier": "ServiceNow", "company_name": "ServiceNow"},
    {"name": "Cato Networks Careers", "kind": "greenhouse", "identifier": "catonetworks", "company_name": "Cato Networks"},
    {"name": "Wiz Careers Israel", "kind": "greenhouse", "identifier": "wizinc", "company_name": "Wiz"},
    {"name": "Orca Security Careers", "kind": "greenhouse", "identifier": "orcasecurity", "company_name": "Orca Security"},
    {"name": "SentinelOne Careers Israel", "kind": "greenhouse", "identifier": "sentinellabs", "company_name": "SentinelOne"},
    ...
    {"name": "Connecteam Careers Israel", "kind": "greenhouse", "identifier": "connecteam", "company_name": "Connecteam"},
    ...
    {"name": "Claroty Careers Israel", "kind": "official_careers", "identifier": "claroty", "company_name": "Claroty"},
    {"name": "VAST Data Careers Israel", "kind": "official_careers", "identifier": "vastdata", "company_name": "VAST Data"},
    {"name": "Gloat Careers Israel", "kind": "official_careers", "identifier": "gloat", "company_name": "Gloat"},
    {"name": "Silverfort Careers Israel", "kind": "official_careers", "identifier": "silverfort", "company_name": "Silverfort"},
    {"name": "4M Analytics Careers Israel", "kind": "official_careers", "identifier": "4manalytics", "company_name": "4M Analytics"},
    {"name": "Exodigo Careers Israel", "kind": "official_careers", "identifier": "exodigo", "company_name": "Exodigo"},
    {"name": "Paragon Careers Israel", "kind": "official_careers", "identifier": "paragon", "company_name": "Paragon"},
    {"name": "Legit Security Careers Israel", "kind": "official_careers", "identifier": "legitsecurity", "company_name": "Legit Security"},
    {"name": "Voyantis Careers Israel", "kind": "official_careers", "identifier": "voyantis", "company_name": "Voyantis"},
    {"name": "Arbe Robotics Careers Israel", "kind": "official_careers", "identifier": "arbe", "company_name": "Arbe Robotics"},
)
...
IEM_RECOMMENDED_SOURCES: tuple[dict[str, str], ...] = (
    ...
    {"name": "AppsFlyer — Operations & Analytics", "kind": "greenhouse", "identifier": "appsflyer", "company_name": "AppsFlyer"},
    {"name": "Pagaya — Operations & Analytics", "kind": "greenhouse", "identifier": "pagayais", "company_name": "Pagaya"},
    {"name": "Check Point — Operations", "kind": "smartrecruiters", "identifier": "CheckPointSoftwareTechnologies2", "company_name": "Check Point"},
    {"name": "CyberArk — Business Operations", "kind": "smartrecruiters", "identifier": "Cyberark1", "company_name": "CyberArk"},
    {"name": "ServiceNow — Business & Engineering Israel", "kind": "smartrecruiters", "identifier": "ServiceNow", "company_name": "ServiceNow"},
    ...
    {"name": "Connecteam — Product & Operations Israel", "kind": "greenhouse", "identifier": "connecteam", "company_name": "Connecteam"},
    ...
    {"name": "VAST Data — Program & Operations Israel", "kind": "official_careers", "identifier": "vastdata", "company_name": "VAST Data"},
    {"name": "Gloat — Product & Business Operations Israel", "kind": "official_careers", "identifier": "gloat", "company_name": "Gloat"},
    {"name": "Exodigo — Product & Field Operations Israel", "kind": "official_careers", "identifier": "exodigo", "company_name": "Exodigo"},
    {"name": "Claroty — Revenue & Business Operations Israel", "kind": "official_careers", "identifier": "claroty", "company_name": "Claroty"},
    {"name": "Silverfort — Business Operations Israel", "kind": "official_careers", "identifier": "silverfort", "company_name": "Silverfort"},
)
...
EE_RECOMMENDED_SOURCES: tuple[dict[str, str], ...] = (
    ...
    {"name":"VAST Data — Hardware Israel","kind":"official_careers","identifier":"vastdata","company_name":"VAST Data"},
    {"name":"Exodigo — Hardware & Systems Israel","kind":"official_careers","identifier":"exodigo","company_name":"Exodigo"},
