...
function applicationProgressMarkup(){
  ...
  const guidedFailureAction=failed&&!manualRequired&&['submit_not_sent','anti_automation_blocked','review_before_submit'].includes(blocker?.kind)?`<div class="card-actions"><button class="btn primary small" type="button" onclick="openInteractiveBlockedApplication(${data.application.id},this)">פתח בדיקה מונחית</button></div>`:'';
