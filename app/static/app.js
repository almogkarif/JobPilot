...
function applicationProgressMarkup(){
  ...
  const gradeSheetPanel=gradeSheetWaiting?(hasGradeSheet
    ? `<div class="application-live-choice application-live-document auto-resolving"><strong>גיליון הציונים כבר נמצא בפרופיל</strong><div class="application-live-auto-document"><span class="live-dot"></span> מצרף אותו אוטומטית ומחזיר את ההגשה לתור</div><small>אין צורך ללחוץ או לאשר שוב. אם זה blocker ישן, ה־worker הקודם כבר הסתיים ולכן ייפתח ניסיון חדש טכנית.</small></div>`
