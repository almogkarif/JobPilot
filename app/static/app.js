...
let applicationTrackingTimer=null,applicationTrackingData=null,applicationTrackingAdvanceTimer=null,applicationTrackingVersion='',applicationTrackingPollBusy=false;
...
async function loadApplicationTimeline(forceVersion=''){if(!trackedApplicationId)return null;const data=await api(`/api/applications/${trackedApplicationId}/timeline`);applicationTrackingData=data;if(data.auto_apply_queue)setAutoApplyQueue(data.auto_apply_queue);if(forceVersion)applicationTrackingVersion=forceVersion;renderNotificationCenter();return data}
