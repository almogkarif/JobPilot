...
PRESETS = {
    ...
    "pliops": {"url": "https://pliops.com/careers/", "selector": 'a[href*="job"], a[href*="position"], a[href*="careers/"]', "id_pattern": r"(?:jobs?|positions?|careers)/([^/?#]+)", "company": "Pliops", "prefer_link_text": True, "http_first": True, "allow_empty": True, "allow_no_links": True},
    ...
    "proteantecs": {"url": "https://www.proteantecs.com/careers", "selector": 'a[href*="careerinfo"], a[href*="/careers/"]', "id_pattern": r"(?:careerinfo\?pi=|/careers/)([^&#/?]+)", "company": "proteanTecs", "prefer_link_text": True, "http_first": True, "allow_empty": True, "allow_no_links": True, "hydrate_details": True, "hydrate_missing_title_only": True, "href_template": "https://www.proteantecs.com/careerinfo?pi={id}", "network_id_keys": ("pi", "positionId", "position_id", "jobId", "job_id", "id"), "network_id_pattern": r"[A-Za-z0-9][A-Za-z0-9.-]{2,40}", "network_title_keys": ("title", "name", "positionTitle", "jobTitle")},
