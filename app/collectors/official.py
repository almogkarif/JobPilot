...
PRESETS = {
    ...
    "proteantecs": {"url": "https://www.proteantecs.com/careers", "selector": 'a[href*="careerinfo"], a[href*="/careers/"]', "id_pattern": r"(?:careerinfo\?pi=|/careers/)([^&#/?]+)", "company": "proteanTecs", "prefer_link_text": True, "http_first": True, "allow_empty": True, "allow_no_links": True, "hydrate_details": True, "hydrate_missing_title_only": True},
